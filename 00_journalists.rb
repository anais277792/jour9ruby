...
def five(number)
    ...
    puts "Il y a #{fives.length} handles contenant 5 caractères."
end
...
def alpha(ordre)
ordre.map(&:downcase)
puts " par ordre alphabétique #{ordre.sort}"
end
